...
public class Game1 extends javax.swing.JInternalFrame {

    private JPanel panel;
    private BufferedImage source;
    private ArrayList<GameCelda> buttons;

    ArrayList<Point> solution = new ArrayList();

    private Image image;
    private GameCelda lastButton;
    private int width, height;
    private final int DESIRED_WIDTH = 400;
    private BufferedImage resized;

    public Game1() throws URISyntaxException {
    ...
    private void initUI() throws URISyntaxException {
        ...
        try {
            ...
            Logger.getLogger(Game1.class.getName()).log(
            ...
            for (int j = 0; j < 3; j++) {
                ...
                image = createImage(new FilteredImageSource(resized.getSource(),
                        new CropImageFilter(j * width / 3, i * height / 4,
                                (width / 3), height / 4)));
                GameCelda button = new GameCelda(image);
                button.putClientProperty("position", new Point(i, j));

                if (i == 3 && j == 2) {
                    lastButton = new GameCelda();
    ...
    private BufferedImage loadImage() throws IOException, URISyntaxException {
      //  new ImageIcon(getClass().getResource(imageName)).getImage();
       // BufferedImage bimg = ImageIO.read(new File());
        ...
        try {
            bimg = ImageIO.read(new File(getClass().getResource("1.png").toURI()));
